...
export default function Dashboard() {
  ...
  function groupUsersByDate(users) {
    ...
    return Object.entries(countsPerDate).map( ([date, count]) => ({   date, count, }) //return object of date and count
  ...
  return (
    <div className="main-container container">
      ...
      <div className="row">
        <h3>User Regisrations Over Time</h3>
        <LineChart width={700} height={300} data={registerDate}>
        <XAxis dataKey="date" />
