...
import {LineChart, Line, XAxis, YAxis, Tooltip, CartesianGrid, ResponsiveContainer,PieChart, Pie, Cell,
...
useEffect(() => {
  fetchAllUsers().then((users) => {
    if (Array.isArray(users)) {
      const allOrders = users.flatMap(user => user.ordersList || []);
      setOrders(allOrders);
 ...
 <div className="col-12 col-md-6">
          <h3 className="pb-3">Users by Role</h3>
