...
export default function SignUp() {
    ...
    return(
        ...
        <div className="bg-white p-5 rounded contiainer-width w-50 w-sm-50 w-md-50 w-100 shadow">
            <h2>Register</h2>
            <form >
                ...
                <button type="submit" className="btn btn-success w-100 rounded-0 custom-width mt-4">Register</button>
